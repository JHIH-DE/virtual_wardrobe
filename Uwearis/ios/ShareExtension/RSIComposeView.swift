...
//
//  Vendored verbatim from receive_sharing_intent 1.9.0's
//  ios/receive_sharing_intent/Sources/receive_sharing_intent/RSIComposeView.swift
//  — see RSIShareViewController.swift's header comment for why this
//  extension target vendors these files instead of linking the package.
//
