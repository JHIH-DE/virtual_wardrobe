...
abstract class AppLocalizations {
  ...
  /// No description provided for @matchingLookEllipsis.
  ///
  /// In en, this message translates to:
  /// **'Matching your look...'**
  String get matchingLookEllipsis;

  /// No description provided for @matchALookFailed.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t match that photo. Please try again.'**
  String get matchALookFailed;

  /// No description provided for @matchALookNoPerson.
  ///
  /// In en, this message translates to:
  /// **'We couldn\'t find a person in that photo. Try a different one.'**
  String get matchALookNoPerson;

  /// No description provided for @matchALookMultiplePeople.
  ///
  /// In en, this message translates to:
  /// **'That photo has more than one person in it. Try a photo with just you.'**
  String get matchALookMultiplePeople;

  /// No description provided for @matchALookOutfitUnclear.
  ///
  /// In en, this message translates to:
  /// **'We couldn\'t see the outfit clearly in that photo. Try a clearer, unobstructed shot.'**
  String get matchALookOutfitUnclear;

  /// No description provided for @matchALookInsufficientCloset.
  ///
  /// In en, this message translates to:
  /// **'Add a few more pieces to your closet before using Match a Look.'**
  String get matchALookInsufficientCloset;

  /// No description provided for @noCloseMatch.
  ///
  /// In en, this message translates to:
  /// **'No close match'**
  String get noCloseMatch;

  /// No description provided for @referenceLookLabel.
  ///
  /// In en, this message translates to:
  /// **'Reference Look'**
  String get referenceLookLabel;

  /// No description provided for @piecesMatchedCount.
  ///
  /// In en, this message translates to:
  /// **'{count} pieces matched'**
  ...
  /// No description provided for @removeReferenceLook.
  ///
  /// In en, this message translates to:
  /// **'Remove Reference Look'**
  String get removeReferenceLook;
  ...
  /// No description provided for @failedToGenerateOutfit.
  ///
  /// In en, this message translates to:
  /// **'Failed to generate outfit'**
  String get failedToGenerateOutfit;

  /// No description provided for @regenerateOutfit.
  ///
  /// In en, this message translates to:
  /// **'Regenerate Outfit'**
  String get regenerateOutfit;

  /// No description provided for @changeGarments.
  ///
  /// In en, this message translates to:
  /// **'Change Garments'**
  String get changeGarments;

  /// No description provided for @noOutfitPlannedYetTitle.
  ///
  /// In en, this message translates to:
  /// **'No outfit planned yet'**
  String get noOutfitPlannedYetTitle;

  /// No description provided for @noOutfitPlannedYetHint.
  ///
  /// In en, this message translates to:
